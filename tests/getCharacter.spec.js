...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  it('Verificar se a função retorna o objeto correto para o parâmetro Arya', () => {
  ...
  // Teste se a função retorna o objeto correto para o parâmetro 'Brienne',
    it('Verificar se a função retorna o objeto correto para o parâmetro Brienne', () => {
  ...
  // Teste se a função retorna o objeto correto para o parâmetro 'Melissandre',
    it('Verificar se a função retorna o objeto correto para o parâmetro Melissandre', () => {
  ...
  it('Verificar se o parâmetro não é Case Sensitive, ou seja, independente de conter letras maiúsculas ou minúsculas retorna o mesmo objeto relativo a ele.', () => {
    expect(getCharacter('ArYa')).toEqual({
      name: 'Arya Stark',
      class: 'Rogue',
      phrases: [ 'Not today', 'A girl has no name.' ]
  ...
  it('Verificar se ao passar um nome que não está na tabela, a função retorna undefined.', () => {
